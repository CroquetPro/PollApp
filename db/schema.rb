...
ActiveRecord::Schema.define(version: 20151112214544) do
  ...
  add_index "responses", ["answer_choice_id", "user_id"], name: "index_responses_on_answer_choice_id_and_user_id", unique: true
